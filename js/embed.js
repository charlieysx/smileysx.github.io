...
function sskua(e) {
	...
	if (r = e.match(/FireFox\/([^\s]+)/ig)) {
		...
		outputer = '<span class="ua_2345explorer"><a href="//ssk.91txh.com/2345download.php?id=2" target="_blank" style="color:#FFFFFF!important;"><i class="fa fa-globe"></i> 2345王牌浏览器</a>'
	} else if (r = e.match(/2345chrome/ig)) {
		outputer = '<span class="ua_2345chrome"><a href="//ssk.91txh.com/2345download.php?id=3" target="_blank" style="color:#FFFFFF!important;"><i class="fa fa-globe"></i> 2345加速浏览器</a>'
		...
		var r1 = r[0].split("/");
		outputer = '<span class="ua_qq"><i class="fa fa-globe"></i> QQ浏览器'
		// + '|' + r1[1].split('.')[0]
		...
		var r1 = r[0].split("/");
		outputer = '<span class="ua_ie"><i class="fa fa-globe"></i> Edge'
		// + '|' + r1[1].split('.')[0]
	} else if (r = e.match(/Chrome([\d]*)\/([^\s]+)/ig)) {
		var r1 = r[0].split("/");
		outputer = '<span class="ua_chrome"><i class="fa fa-globe"></i> Chrome'
		// + '|' + r1[1].split('.')[0]
	} else if (r = e.match(/safari\/([^\s]+)/ig)) {
		var r1 = r[0].split("/");
		outputer = '<span class="ua_apple"><i class="fa fa-globe"></i> Apple Safari'
		 // + '|' + r1[1]
	} else if (r = e.match(/Opera[\s|\/]([^\s]+)/ig)) {
		var r1 = r[0].split("/");
		outputer = '<span class="ua_opera"><i class="fa fa-globe"></i> Opera'
		 // + '|' + r[1]
	} else if (r = e.match(/Trident\/7.0/gi)) {
		outputer = '<span class="ua_ie"><i class="fa fa-globe"></i> Internet Explorer 11'
	} else if (r = e.match(/MSIE\s([^\s|;]+)/gi)) {
		outputer = '<span class="ua_ie"><i class="fa fa-globe"></i> Internet Explorer'
		 // + '|' + r[0]
